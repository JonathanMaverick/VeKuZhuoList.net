...
<body class="bg-customBlack flex justify-center items-center flex-col overflow-x-hidden">
          ...
          <div class="dropdown hover:bg-grayLight flex items-center cursor-pointer px-4 relative">
            ...
            <div
              ...
              <a class="py-[10px] px-[15px] hover:bg-white hover:text-grayLight"
                href="{{ route('anime.top_views') }}">Top
                Viewed Anime</a>
              <a class="py-[10px] px-[15px] hover:bg-white hover:text-grayLight"
  ...
  {{-- Footer --}}
  <div class="footer bg-grayMid w-screen mt-[30px] p-[50px] text-lightFont flex flex-col items-center justify-center">
