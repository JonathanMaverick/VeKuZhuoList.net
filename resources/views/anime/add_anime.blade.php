  ...
  <div
    ...
    <form action="{{ route('anime.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="container flex gap-[20px] p-0">
        <div class="left flex-1 flex flex-col gap-[10px]">
          <div class="text-lightFont flex flex-col">
            ...
            <input class="bg-grayLight text-white py-[5px] px-[10px] rounded-sm" type="text" class="form-control"
              id="anime_name" name="anime_name" value="{{ old('anime_name') }}">
          </div>
          <div class="text-lightFont flex flex-col">
            ...
            <input class="bg-grayLight text-white py-[5px] px-[10px] rounded-sm" type="number" class="form-control"
              id="views" name="views" value="{{ old('views') }}">
          </div>
          <div class="text-lightFont flex flex-col">
            <label for="synopsis">Synopsis</label>
            <textarea class="bg-grayLight text-white py-[5px] px-[10px] rounded-sm h-[100px]" id="synopsis" name="synopsis">{{ old('synopsis') }}</textarea>
          </div>
          <div class="text-lightFont flex flex-col">
            <label for="total_episodes" class="form-label m-0">Total Episodes</label>
            <input class="bg-grayLight text-white py-[5px] px-[10px] rounded-sm" type="number" class="form-control"
              id="total_episodes" name="total_episodes" value="{{ old('total_episodes') }}">
          </div>
          <div class="text-lightFont flex flex-col">
        ...
        <div class="right flex-1 flex flex-col gap-[10px]">
          ...
          <div class="text-lightFont flex flex-col">
            ...
            <img class="w-[130px] border-[1px] border-border mt-[8px]" id="image-preview">
          </div>
        </div>
      </div>
      ...
      <div class="text-lightFont flex flex-col">
              ...
              <div class="character-entry" id="character-entry-{{ $index }}">
                <div class="flex flex-row gap-[20px]">
                  ...
                  <div class="flex items-end">
                    <button type="button"
                      class="btn btn-danger remove-character h-[31.5px] flex items-center rounded-sm"
        ...
        <button class="text-white bg-customBlue h-[40px] rounded-sm mt-[20px]" type="submit">Add</button>
      </div>
    </form>
